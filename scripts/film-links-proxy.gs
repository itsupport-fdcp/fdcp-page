/**
 * RETIRED (2026-09-10) — Ticket Tailor is no longer used. Manila now comes
 * from the schedule Google Sheet like every other location, and
 * pages/cinematheque.html no longer calls this web app. Kept as the source
 * record for the still-deployed Apps Script; safe to delete once that
